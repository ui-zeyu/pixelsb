...
FILTER_TIP = (
    ...
    "rect 选中矩形（含边界），四条边可具名："
    "rect(left=50, top=50, right=100, bottom=100)，也可按顺序写 rect(50, 50, 100, 100)；"
    "等价写法是 50 <= left <= 100 and 50 <= top <= 100。"
    "例：rect(left=50, top=50, right=100, bottom=100) and B >= R。"
